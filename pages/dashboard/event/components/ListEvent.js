...
export default function ListEvent({ events, getData }) {
                    ...
                    <td>
                      <div className="row justify-content-center inline-block">
                        <div className="text-center m-1">
                          <Link
                            href={`/dashboard/event/detailz?id=${row.id_event}`}
                        ...
                        <div className="text-center m-1">
                          <Link
                            href={`/dashboard/event/editz?id=${row.id_event}`}
