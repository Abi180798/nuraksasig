...
export default function ListWisata({ wisatas, getData }) {
        ...
        <div className="table-responsive">
          <div className="mr-0 mt-0">
            <Link href="/dashboard/wisata/addz">
              <a className="btn btn-primary float-right mt-3">Tambah Data</a>
            </Link>
          </div>
          <table
                    ...
                    <td>
                      <div className="row justify-content-center inline-block">
                        <div className="text-center m-1">
                          <Link
                            href={`/dashboard/wisata/detailz?id_wisata=${row.id_wisata}`}
                        ...
                        <div className="text-center m-1">
                          <Link
                            href={`/dashboard/wisata/editz?id_wisata=${row.id_wisata}`}
